...
println("df0...")
#Simple dataset
df0         = load(path*"/csv/df0.csv") |> DataFrame
println("df1...")
...
df1         = load(path*"/csv/df1.csv") |> DataFrame
println("df2...")
...
df2         = load(path*"/csv/df2.csv") |> DataFrame
println("df3...")
...
df3         = load(path*"/csv/df3.csv") |> DataFrame
println("df4...")
#QA 1 Bioequivalence 2x2x4, UnB, NC Dataset
df4         = load(path*"/csv/df4.csv") |> DataFrame
println("df5...")
